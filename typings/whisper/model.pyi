...
@contextmanager
def disable_sdpa(): # -> Generator[None, Any, None]:
    ...
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x: Tensor, xa: Optional[Tensor] = ..., mask: Optional[Tensor] = ..., kv_cache: Optional[dict] = ...): # -> tuple[Any, Tensor | None]:
        ...
    
    def qkv_attention(self, q: Tensor, k: Tensor, v: Tensor, mask: Optional[Tensor] = ...) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
